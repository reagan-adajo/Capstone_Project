...
•	In-store Sales Data (sales.csv): Daily sales records including quantity sold, pricing, and revenue metrics
•	Online Sales Data (online.csv): Store-specific e-commerce transaction data
•	Pricing Information: 
